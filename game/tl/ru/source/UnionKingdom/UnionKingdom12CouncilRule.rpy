...
# Scene: UnionKingdom12CouncilRule
# Total blocks: 53

# UnionKingdom12CouncilRule_14c1d8cd (line 14142)
translate ru UnionKingdom12CouncilRule_14c1d8cd:
    # "When they finally reconvened, a heavy atmosphere seemed to hang over the room."
    ""

# UnionKingdom12CouncilRule_9b542838 (line 14143)
translate ru UnionKingdom12CouncilRule_9b542838:
    # "Maeiv was the first to assert herself."
    ""
...
translate ru UnionKingdom12CouncilRule_d08d4953:
    # "She paused as she looked about the room."
    ""
...
translate ru UnionKingdom12CouncilRule_a78e80e3:
    # "Sarah could see the others shake their head in disbelief."
    ""
...
translate ru UnionKingdom12CouncilRule_f4d07b9e:
    # "Maeiv only smiled at their comments."
    ""
...
translate ru UnionKingdom12CouncilRule_b7bb0314:
    # "She was quick to add a last comment."
    ""
...
translate ru UnionKingdom12CouncilRule_2e3518e3:
    # "Sarah could hear the others scoff. Few believed her."
    ""

# UnionKingdom12CouncilRule_37595d45 (line 14161)
translate ru UnionKingdom12CouncilRule_37595d45:
    # "Sarah stood up."
    ""

# UnionKingdom12CouncilRule_c08e6f05 (line 14168)
translate ru UnionKingdom12CouncilRule_c08e6f05:
    # "The others all looked at her, surprised by her sudden motion."
    ""
...
translate ru UnionKingdom12CouncilRule_5ae44fc4:
    # "Sarah paused as she looked about the room and saw that each of them agreed."
    ""
...
translate ru UnionKingdom12CouncilRule_6f327b0b:
    # "Sarah placed the palms of her hands on the table."
    ""
...
translate ru UnionKingdom12CouncilRule_f6da3b35:
    # "Her question was answered only with silence."
    ""
...
translate ru UnionKingdom12CouncilRule_7548ef66:
    # "Sarah could see the others nod."
    ""

# UnionKingdom12CouncilRule_bdc72acc (line 14187)
translate ru UnionKingdom12CouncilRule_bdc72acc:
    # "Each understood that perhaps they would have liked to be in charge, but each also understood they would never gain enough support."
    ""

# UnionKingdom12CouncilRule_7801fe0a (line 14188)
translate ru UnionKingdom12CouncilRule_7801fe0a:
    # "At least now, they would all have a share of the power."
    ""

# UnionKingdom12CouncilRule_308c41c7 (line 14189)
translate ru UnionKingdom12CouncilRule_308c41c7:
    # "Antonio was the first to speak up."
    ""
...
translate ru UnionKingdom12CouncilRule_7e1ace27:
    # "Sarah looked at Queen Maeiv. She could see that she had lost."
    ""
...
translate ru UnionKingdom12CouncilRule_1da3a719:
    # "Now that the room had shifted in favor of Sarah's position, Maeiv was quick to turn with the shifting winds."
    ""
...
translate ru UnionKingdom12CouncilRule_ae50391f:
    # "The others banged the table to voice their support."
    ""

# UnionKingdom12CouncilRule_382d80e3 (line 14200)
translate ru UnionKingdom12CouncilRule_382d80e3:
    # "Even Maeiv, reluctantly, joined in."
    ""
