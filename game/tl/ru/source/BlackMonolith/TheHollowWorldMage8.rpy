...
# Scene: TheHollowWorldMage8
# Total blocks: 87

# TheHollowWorldMage8_a8249d46 (line 76341)
translate ru TheHollowWorldMage8_a8249d46:
    # "More than a month had passed since Sarah had returned from Bagrad."
    ""

# TheHollowWorldMage8_209f35bf (line 76342)
translate ru TheHollowWorldMage8_209f35bf:
    # "Most of her days had been spend since studying under the guidance of Razaphel."
    ""

# TheHollowWorldMage8_0ea55aa0 (line 76343)
translate ru TheHollowWorldMage8_0ea55aa0:
    # "One book, then the next."
    ""

# TheHollowWorldMage8_e6bd6dd9 (line 76344)
translate ru TheHollowWorldMage8_e6bd6dd9:
    # "Some of it had been frustrating, never truly knowing what any of it amounted to, but in another part she was grateful."
    ""

# TheHollowWorldMage8_001fb2a1 (line 76345)
translate ru TheHollowWorldMage8_001fb2a1:
    # "Grateful for the distraction. Grateful to have something she could put her mind to."
    ""

# TheHollowWorldMage8_01d3e15e (line 76353)
translate ru TheHollowWorldMage8_01d3e15e:
    # "Early this particular morning, Sarah had made her way through the house and found herself back at Xan's private study."
    ""

# TheHollowWorldMage8_a7f39c88 (line 76354)
translate ru TheHollowWorldMage8_a7f39c88:
    # "She couldn't remember if she walked her on her own, or perhaps whether the house had guided her here."
    ""

# TheHollowWorldMage8_bcdf95f6 (line 76355)
translate ru TheHollowWorldMage8_bcdf95f6:
    # "Sarah wasn't even sure if the difference mattered."
    ""

# TheHollowWorldMage8_5d7a1abf (line 76356)
translate ru TheHollowWorldMage8_5d7a1abf:
    # "As she slowly made her way around his study, looking over at all the different collections of books and artifacts, she could see his desk from the corner of her eyes."
    ""

# TheHollowWorldMage8_9b1f48bb (line 76357)
translate ru TheHollowWorldMage8_9b1f48bb:
    # "And on the desk, the book of their order. The Hollow World."
    ""

# TheHollowWorldMage8_6d2a489f (line 76358)
translate ru TheHollowWorldMage8_6d2a489f:
    # "Sarah slowly made her way towards the desk."
    ""

# TheHollowWorldMage8_bb5d77c2 (line 76359)
translate ru TheHollowWorldMage8_bb5d77c2:
    # "Reaching down with the tip of her fingers, she lifted up the cover and flipped the book open."
    ""

# TheHollowWorldMage8_0bf09cef (line 76360)
translate ru TheHollowWorldMage8_0bf09cef:
    # "Massive. indecipherable."
    ""

# TheHollowWorldMage8_d14dfec4 (line 76361)
translate ru TheHollowWorldMage8_d14dfec4:
    # "She wasn't sure if even after all of Razaphel's guidance, whether she had gotten any closer to making sense of it."
    ""

# TheHollowWorldMage8_1db36802 (line 76362)
translate ru TheHollowWorldMage8_1db36802:
    # "The book had become like a splinter in her mind, impossible to ignore."
    ""

# TheHollowWorldMage8_e8b9aad8 (line 76365)
translate ru TheHollowWorldMage8_e8b9aad8:
    # "Near her, Sarah could see the air stir as the spirit manifested itself."
    ""
...
translate ru TheHollowWorldMage8_4dd39441:
    # "Sarah tapped the book with her knuckles."
    ""
...
translate ru TheHollowWorldMage8_9c8cf3a4:
    # "For a moment, the spirit was silent."
    ""
...
translate ru TheHollowWorldMage8_ca2c52dc:
    # "Sarah turned to face the spirit."
    ""
...
translate ru TheHollowWorldMage8_dbf34e6d:
    # "The spirit drifted through the room."
    ""

# TheHollowWorldMage8_41c56512 (line 76385)
translate ru TheHollowWorldMage8_41c56512:
    # "It liked to speak, but now it seemed hesitant."
    ""
...
translate ru TheHollowWorldMage8_568f36e1:
    # "Sarah found herself smiling, surprised at the sudden confession."
    ""
...
translate ru TheHollowWorldMage8_99872c8e:
    # "The spirit turned its face-mask towards her."
    ""
...
translate ru TheHollowWorldMage8_1f681018:
    # "Sarah looked on the spirit, it's shape breaking apart, as if under some great stress."
    ""
...
translate ru TheHollowWorldMage8_89383d14:
    # "Sarah studied the spirit. Answers, finally."
    ""
...
translate ru TheHollowWorldMage8_83d47f90:
    # "Sarah lowered her head, thinking."
    ""
...
translate ru TheHollowWorldMage8_c22534ab:
    # "Sarah knew that the house connected to many spaces across the world, so the spirit's words seemed obvious in hindsight."
    ""
...
translate ru TheHollowWorldMage8_41730365:
    # "Sarah observed the spirit for a moment."
    ""

# TheHollowWorldMage8_59a13c97 (line 76423)
translate ru TheHollowWorldMage8_59a13c97:
    # "It had resumed its regular form, no longer distressed. Back to its unreadable state."
    ""

# TheHollowWorldMage8_5391fadd (line 76424)
translate ru TheHollowWorldMage8_5391fadd:
    # "Then she nodded."
    ""
...
translate ru TheHollowWorldMage8_88219b46:
    # "She stared at Razaphel intently."
    ""
...
# TheHollowWorldMage8_de3dd70b (line 76431)
translate ru TheHollowWorldMage8_de3dd70b:
    # "Alone again in the study, Sarah contemplated everything Razaphel had told her."
    ""

# TheHollowWorldMage8_1373eb94 (line 76432)
translate ru TheHollowWorldMage8_1373eb94:
    # "A strange city she had never heard of, on the edge of the world. An object, buried deep in the sand."
    ""

# TheHollowWorldMage8_8b2b305f (line 76433)
translate ru TheHollowWorldMage8_8b2b305f:
    # "It all meant very little to her."
    ""

# TheHollowWorldMage8_a50eb9bd (line 76434)
translate ru TheHollowWorldMage8_a50eb9bd:
    # "Except for the answers he finally promised her."
    ""

# TheHollowWorldMage8_0594e01a (line 76440)
translate ru TheHollowWorldMage8_0594e01a:
    # "Sarah had spend the rest of the day preparing."
    ""

# TheHollowWorldMage8_1b4b9ef9 (line 76441)
translate ru TheHollowWorldMage8_1b4b9ef9:
    # "Gathering up supplies, some food and water, basic spell books, some spell reagants."
    ""

# TheHollowWorldMage8_ce8153ab (line 76442)
translate ru TheHollowWorldMage8_ce8153ab:
    # "It wasn't much, but Sarah couldn't be sure what would be waiting for her on the other side. Best be prepared."
    ""
