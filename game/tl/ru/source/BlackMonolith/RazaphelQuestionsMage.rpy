...
# RazaphelQuestionsMage_643b9f6a (line 76997)
translate ru RazaphelQuestionsMage_643b9f6a:
...
# RazaphelQuestionsMage_6ff350e6 (line 77010)
translate ru RazaphelQuestionsMage_6ff350e6:
    # "But who was this spirit, truly? She sensed there was a truth in his words, but truth did not mean that he could not deceive."
    ""

# RazaphelQuestionsMage_5a328e38 (line 77011)
translate ru RazaphelQuestionsMage_5a328e38:
    # "Perhaps the spirit had only told her enough truth to twist her to it's own designs."
    ""

# RazaphelQuestionsMage_d76d6fdb (line 77012)
translate ru RazaphelQuestionsMage_d76d6fdb:
    # "What did she truly know of such witchcraft?"
    ""

# RazaphelQuestionsMage_0fc79b0c (line 77013)
translate ru RazaphelQuestionsMage_0fc79b0c:
    # "And yet, if he spoke true and she walked away...would she be forever a slave?"
    ""

# RazaphelQuestionsMage_0c749783 (line 77014)
...
# RazaphelQuestionsMage_a732699f (line 77143)
translate ru RazaphelQuestionsMage_a732699f:
    # "Her body was trapped. A darkness, everywhere."
    ""

# RazaphelQuestionsMage_29de2658 (line 77144)
translate ru RazaphelQuestionsMage_29de2658:
    # "On the edges of her body, she felt the shifting sands. Then the eager hands."
    ""

# RazaphelQuestionsMage_99b0b26a (line 77145)
translate ru RazaphelQuestionsMage_99b0b26a:
    # "Voice" "We found her!"
    ""

# RazaphelQuestionsMage_08ecc748 (line 77146)
translate ru RazaphelQuestionsMage_08ecc748:
    # "Voice" "Hurry up, dig her out!"
    ""

# RazaphelQuestionsMage_af6b5c85 (line 77147)
translate ru RazaphelQuestionsMage_af6b5c85:
    # "Slowly, the world regained its forms and colours."
    ""

# RazaphelQuestionsMage_0a958353 (line 77155)
translate ru RazaphelQuestionsMage_0a958353:
    # "Hands wrapped themselves around her limbs and pulled her out from the sand."
    ""

# RazaphelQuestionsMage_882b7de0 (line 77156)
translate ru RazaphelQuestionsMage_882b7de0:
    # "Sarah sputtered as she spat out a mouthful of sand."
    ""

# RazaphelQuestionsMage_d6ec3bf1 (line 77157)
translate ru RazaphelQuestionsMage_d6ec3bf1:
    # "She saw the frightened faces of scholars surrounding her."
    ""

# RazaphelQuestionsMage_bef781b6 (line 77158)
translate ru RazaphelQuestionsMage_bef781b6:
    # "Scholar" "Are you alright?"
    ""

# RazaphelQuestionsMage_82b4fbbc (line 77159)
translate ru RazaphelQuestionsMage_82b4fbbc:
    # "Scholar" "Did the scaffolding break? What happened?"
    ""

# RazaphelQuestionsMage_df7395da (line 77160)
translate ru RazaphelQuestionsMage_df7395da:
    # "Sarah waved her hand and pushed them away from herself."
    ""

# RazaphelQuestionsMage_81fa4348 (line 77161)
translate ru RazaphelQuestionsMage_81fa4348:
    # "She coughed up more of the sand."
    ""

# RazaphelQuestionsMage_c2400324 (line 77162)
translate ru RazaphelQuestionsMage_c2400324:
    # "Slowly, she managed to recover herself."
    ""
...
translate ru RazaphelQuestionsMage_f38832cc:
    # "She saw the scholars slowly back away from her."
    ""

# RazaphelQuestionsMage_3368fbb1 (line 77165)
translate ru RazaphelQuestionsMage_3368fbb1:
    # "Confusion in their faces. They were trying to figure out who she was. What she was doing here."
    ""

# RazaphelQuestionsMage_29164c38 (line 77166)
translate ru RazaphelQuestionsMage_29164c38:
    # "Sarah had no good answers for them."
    ""

# RazaphelQuestionsMage_6acc28dd (line 77167)
translate ru RazaphelQuestionsMage_6acc28dd:
    # "Recovered enough, Sarah leapt up to her feet."
    ""

# RazaphelQuestionsMage_22f361c2 (line 77168)
translate ru RazaphelQuestionsMage_22f361c2:
    # "She pushed her way passed the still startled scholars."
    ""

# RazaphelQuestionsMage_dc343154 (line 77169)
translate ru RazaphelQuestionsMage_dc343154:
    # "Before they could say much more, she began to run."
    ""

# RazaphelQuestionsMage_fd1492d0 (line 77170)
translate ru RazaphelQuestionsMage_fd1492d0:
    # "Behind her, she could hear their voices. First calm, then swiftly rising."
    ""

# RazaphelQuestionsMage_30f5fb09 (line 77171)
translate ru RazaphelQuestionsMage_30f5fb09:
    # "Scholar" "Hey!"
    ""

# RazaphelQuestionsMage_8d296b2f (line 77172)
translate ru RazaphelQuestionsMage_8d296b2f:
    # "Scholar" "Stop her!"
    ""

# RazaphelQuestionsMage_ec6617bf (line 77173)
translate ru RazaphelQuestionsMage_ec6617bf:
    # "Sarah was already halfway up the scaffolding, her feet racing."
    ""

# RazaphelQuestionsMage_c697c654 (line 77174)
translate ru RazaphelQuestionsMage_c697c654:
    # "She could feel the pain in her limbs; injuries from the fall. Considering the height, they felt trivial."
    ""

# RazaphelQuestionsMage_1b1c2148 (line 77175)
translate ru RazaphelQuestionsMage_1b1c2148:
    # "She planted her feet, one after the other, swiftly, racing up the wooden construction."
    ""

# RazaphelQuestionsMage_debcae5e (line 77176)
translate ru RazaphelQuestionsMage_debcae5e:
    # "More sounds of people calling out after her. Asking for someone to stop her. Nobody did."
    ""

# RazaphelQuestionsMage_41764d90 (line 77183)
translate ru RazaphelQuestionsMage_41764d90:
    # "Coming up over the edge of the pit, Sarah ran out across the road."
    ""

# RazaphelQuestionsMage_be63763b (line 77184)
translate ru RazaphelQuestionsMage_be63763b:
    # "The city spun around her, the ruins disorienting. Where. Where had she come from."
    ""

# RazaphelQuestionsMage_612c807f (line 77185)
translate ru RazaphelQuestionsMage_612c807f:
    # "Sarah closed her eyes and focussed."
    ""

# RazaphelQuestionsMage_ca2830f2 (line 77186)
translate ru RazaphelQuestionsMage_ca2830f2:
    # "She forced her mind to be calm. In the darkness of her mind, she reached out and felt the latent magical energy."
    ""

# RazaphelQuestionsMage_2c670326 (line 77187)
translate ru RazaphelQuestionsMage_2c670326:
    # "The energy she'd left behind to guide her way back to the door through which she had come."
    ""

# RazaphelQuestionsMage_e2d11526 (line 77188)
translate ru RazaphelQuestionsMage_e2d11526:
    # "Then she felt it."
    ""

# RazaphelQuestionsMage_98d6e0ee (line 77189)
translate ru RazaphelQuestionsMage_98d6e0ee:
    # "Sarah opened her eyes, oriented herself towards the energy, and continued to run."
    ""

# RazaphelQuestionsMage_7b0863fe (line 77190)
translate ru RazaphelQuestionsMage_7b0863fe:
    # "By now, the shouts were growing louder and louder."
    ""

# RazaphelQuestionsMage_ce9b4686 (line 77191)
translate ru RazaphelQuestionsMage_ce9b4686:
    # "She heard the rough and hard voices of soldiers. The clattering of boots against stone."
    ""

# RazaphelQuestionsMage_8f7436db (line 77197)
translate ru RazaphelQuestionsMage_8f7436db:
    # "Sarah made her way further down the road."
    ""

# RazaphelQuestionsMage_6eca2ffc (line 77198)
translate ru RazaphelQuestionsMage_6eca2ffc:
    # "She had a distance on them, she could make it before they would catch up to her. She just needed to keep running."
    ""

# RazaphelQuestionsMage_d911e0cd (line 77199)
translate ru RazaphelQuestionsMage_d911e0cd:
    # "Her feet raced under her, each step following the next."
    ""

# RazaphelQuestionsMage_bf1a1ca4 (line 77200)
translate ru RazaphelQuestionsMage_bf1a1ca4:
    # "Her lungs were burning, half from the exhaustion, half from the sand that was still in her lungs."
    ""

# RazaphelQuestionsMage_fe3684f4 (line 77201)
translate ru RazaphelQuestionsMage_fe3684f4:
    # "Coughing, she continued to force herself to run."
    ""

# RazaphelQuestionsMage_28d167a9 (line 77202)
translate ru RazaphelQuestionsMage_28d167a9:
    # "Behind her, she could hear the sounds of soldiers coming closer."
    ""

# RazaphelQuestionsMage_83731cbd (line 77203)
translate ru RazaphelQuestionsMage_83731cbd:
    # "She turned her hear around and saw the light of torches. Search parties."
    ""

# RazaphelQuestionsMage_6af9ab62 (line 77204)
translate ru RazaphelQuestionsMage_6af9ab62:
    # "Run. Run. Run."
    ""

# RazaphelQuestionsMage_d781092d (line 77205)
translate ru RazaphelQuestionsMage_d781092d:
    # "Sarah repeated the words in her head like a mantra."
    ""

# RazaphelQuestionsMage_70e9d644 (line 77206)
translate ru RazaphelQuestionsMage_70e9d644:
    # "Turning back to face in front of her, she suddenly felt her heart stop."
    ""

# RazaphelQuestionsMage_3f07ca33 (line 77207)
translate ru RazaphelQuestionsMage_3f07ca33:
    # "A group of soldiers blocked the road up ahead of her."
    ""

# RazaphelQuestionsMage_eec3a0e5 (line 77208)
translate ru RazaphelQuestionsMage_eec3a0e5:
    # "Sarah stopped."
    ""

# RazaphelQuestionsMage_eb411a58 (line 77209)
translate ru RazaphelQuestionsMage_eb411a58:
    # "For a brief moment, she expected them to call out to her, but judging by their body language, she could see they were still searching."
    ""

# RazaphelQuestionsMage_41be4674 (line 77210)
translate ru RazaphelQuestionsMage_41be4674:
    # "They had their torches, but she was standing in the darkness. They missed her."
    ""

# RazaphelQuestionsMage_6014d593 (line 77211)
translate ru RazaphelQuestionsMage_6014d593:
    # "Sarah quickly ran to the side of the road, jumping into one of the ruined homes that littered the city."
    ""

# RazaphelQuestionsMage_6e833da9 (line 77217)
translate ru RazaphelQuestionsMage_6e833da9:
    # "She lowered her head and looked out over the edge of the broken wall that had one been a proper one."
    ""

# RazaphelQuestionsMage_e7f93499 (line 77218)
translate ru RazaphelQuestionsMage_e7f93499:
    # "The group of soldiers were discussing among themselves."
    ""

# RazaphelQuestionsMage_2c188ca7 (line 77219)
translate ru RazaphelQuestionsMage_2c188ca7:
    # "More joined, the ones that been close behind her."
    ""

# RazaphelQuestionsMage_fe79a591 (line 77220)
translate ru RazaphelQuestionsMage_fe79a591:
    # "Talking. Shouting."
    ""

# RazaphelQuestionsMage_fcf3a55f (line 77221)
translate ru RazaphelQuestionsMage_fcf3a55f:
    # "She could hardly make it out, but they appeared animated."
    ""

# RazaphelQuestionsMage_4a0f5b0e (line 77222)
translate ru RazaphelQuestionsMage_4a0f5b0e:
    # "A few wobbled about, clearly drunk."
    ""

# RazaphelQuestionsMage_b8727f3b (line 77223)
translate ru RazaphelQuestionsMage_b8727f3b:
    # "They had not been expecting to have to do any real work tonight, that much was clear to her."
    ""

# RazaphelQuestionsMage_3509dbb7 (line 77224)
translate ru RazaphelQuestionsMage_3509dbb7:
    # "Looking at the soldiers, Sarah estimated there were about twenty of them, give or take."
    ""

# RazaphelQuestionsMage_2f85698a (line 77225)
translate ru RazaphelQuestionsMage_2f85698a:
    # "The truth was, she didn't really fear them."
    ""

# RazaphelQuestionsMage_7df1273e (line 77226)
translate ru RazaphelQuestionsMage_7df1273e:
    # "She wasn't afraid of what would happen to her if they caught her."
    ""

# RazaphelQuestionsMage_e48b2807 (line 77227)
