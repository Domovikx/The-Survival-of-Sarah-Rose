...
translate ru strings:
    ...
    new "Нажмите для воспроизведения видео."
    ...
    new "Текст высокой контрастности"

    # renpy/common/00accessibility.rpy:224
    old "Text Size Scaling"
    new "Масштаб размера текста"
    ...
    new "Меню специальных возможностей. Используйте стрелки вверх и вниз для навигации, и Enter для активации кнопок и ползунков."

    # renpy/common/00accessibility.rpy:288
    old "Self-Voicing and Audio"
    new "Озвучивание и звук"
    ...
    new "Опции в этом меню предназначены для улучшения специальных возможностей. Они могут работать не со всеми играми, а некоторые комбинации опций могут сделать игру неиграбельной. Это не проблема игры или движка. Для лучших результатов при изменении шрифтов старайтесь сохранять размер текста таким же, каким он был изначально."
    ...
    new "Интерактивный директор здесь недоступен."
    ...
    new "Клик для переключения атрибута, правый клик для переключения отрицательного атрибута."
    ...
    new "Клик для установки трансформации, правый клик для добавления в список."

    # renpy/common/00director.rpy:1777
    old "Customize director.transforms to add more transforms."
    new "Настройте director.transforms для добавления трансформаций."
    ...
    new "Клик для установки, правый клик для добавления в список."
    ...
    new "Настройте director.transitions для добавления переходов."
    ...
    new "Настройте director.audio_channels для добавления каналов."
    ...
    new "Вы уверены, что хотите пропустить непрочитанный диалог до следующего выбора?"

    # renpy/common/00gui.rpy:459
    old "This save was created on a different device. Maliciously constructed save files can harm your computer. Do you trust this save's creator and everyone who could have changed the file?"
    new "Это сохранение было создано на другом устройстве. Вредоносные файлы сохранений могут нанести вред вашему компьютеру. Вы доверяете создателю этого сохранения и всем, кто мог изменить файл?"
    ...
    new "Эта программа содержит свободное программное обеспечение под несколькими лицензиями, включая MIT License и GNU Lesser General Public License. Полный список ПО, включая ссылки на полный исходный код, можно найти {a=https://www.renpy.org/l/license}здесь{/a}."
    ...
    new "пропускать непрочитанное [text]"
    ...
    new "озвучивание буфера"

    # renpy/common/00preferences.rpy:462
    old "clipboard voicing enable"
    new "включить озвучивание буфера"

    # renpy/common/00preferences.rpy:464
    old "clipboard voicing disable"
    new "отключить озвучивание буфера"
    ...
    new "включить отладку озвучивания"

    # renpy/common/00preferences.rpy:473
    old "debug voicing disable"
    new "отключить отладку озвучивания"
    ...
    new "Озвучивание буфера обмена включено. Нажмите 'Shift+C' для отключения."

    # renpy/common/00preferences.rpy:725
    old "Self-voicing would say \"[renpy.display.tts.last]\". Press 'alt+shift+V' to disable."
    new "Озвучивание скажет \"[renpy.display.tts.last]\". Нажмите 'Alt+Shift+V' для отключения."

    # renpy/common/00preferences.rpy:727
    old "Self-voicing enabled. Press 'v' to disable."
    new "Озвучивание включено. Нажмите 'v' для отключения."

    # renpy/common/00speechbubble.rpy:420
    old "Speech Bubble Editor"
    new "Редактор облачков"
    ...
    new "(очистить сохранённые облачка)"
    ...
    new "Сервер Ren'Py Sync не отвечает."
    ...
    new "Сервер Ren'Py Sync не имеет копии этой синхронизации. ID синхронизации может быть неверным или устаревшим."

    # renpy/common/00sync.rpy:305
    old "Please enter the sync ID you generated.\nNever enter a sync ID you didn't create yourself."
    new "Пожалуйста, введите ID синхронизации, который вы сгенерировали.\nНикогда не вводите ID синхронизации, который вы не создавали сами."
    ...
    new "Этот проект не поддерживает обновления, или файл статуса обновления был удалён."

    # renpy/common/00updater.rpy:877
    old "This account does not have permission to perform an update."
    new "У этого аккаунта нет прав для выполнения обновления."

    # renpy/common/00updater.rpy:880
    old "This account does not have permission to write the update log."
    new "У этого аккаунта нет прав для записи лога обновления."
    ...
    new "[u.version] доступна. Вы хотите установить?"
    ...
    new "Ошибка при загрузке данных игры:"

    # renpy/common/00updater.rpy:1997
    old "This game cannot be run until the game data has been downloaded."
    new "Игра не может быть запущена, пока данные не будут загружены."
...
# renpy/common/00gallery.rpy:699
    ...
    new "Принудительный GL2"

    # renpy/common/00gltest.rpy:101
    old "Force ANGLE2 Renderer"
    new "Принудительный ANGLE2"

    # renpy/common/00gltest.rpy:106
    old "Force GLES2 Renderer"
    new "Принудительный GLES2"
    ...
    new "Изменения вступят в силу при следующем запуске."
    ...
    new "На этом компьютере проблема с отображением графики: [problem]."

    # renpy/common/00gltest.rpy:220
    old "Its graphics drivers may be out of date or not operating correctly. This can lead to slow or incorrect graphics display."
    new "Драйверы графики могут быть устаревшими или работать некорректно. Это может привести к медленному или неправильному отображению."

    # renpy/common/00gltest.rpy:224
    old "The {a=edit:1:log.txt}log.txt{/a} file may contain information to help you determine what is wrong with your computer."
    new "Файл {a=edit:1:log.txt}log.txt{/a} может содержать информацию для диагностики проблемы."

    # renpy/common/00gltest.rpy:229
    old "More details on how to fix this can be found in the {a=[url]}documentation{/a}."
    new "Подробности о решении проблемы можно найти в {a=[url]}документации{/a}."

    # renpy/common/00gltest.rpy:234
    old "Continue, Show this warning again"
    new "Продолжить, показать снова"

    # renpy/common/00gltest.rpy:238
    old "Continue, Don't show warning again"
    new "Продолжить, больше не показывать"
    ...
    new "Копирует файл traceback.txt в буфер обмена как BBCode для форумов."
    ...
    new "Пытается откатиться к предыдущему состоянию, позволяя сохраниться или выбрать другой вариант."
    ...
    new "Перезагружает игру с диска, сохраняя и восстанавливая состояние если возможно."
    ...
    new "Открывает консоль для отладки."
